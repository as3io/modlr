...
You can run the unit-tests by calling ``bin/phpunit`` from the root of the project.
...
so please make sure that your code is working after opening up a Pull-Request.

## Scrutinizer

We automatically run your pull request through [Scrutinizer](https://scrutinizer-ci.com)
to ensure code quality. Please make sure you address any concerns reported by scrutinizer.
